...
var StyledButton = styled_components_1.default.button(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  align-items: center;\n  cursor: pointer;\n  display: flex;\n  justify-content: center;\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n\n  @media(max-width: 768px){\n    font-size: ", "px;\n    height: 52px;\n  };\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  &:focus {\n    background-color: ", ";\n  }\n"], ["\n  align-items: center;\n  cursor: pointer;\n  display: flex;\n  justify-content: center;\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n\n  @media(max-width: 768px){\n    font-size: ", "px;\n    height: 52px;\n  };\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  &:focus {\n    background-color: ", ";\n  }\n"])), borderColor, borderRadius, borders, color, fontSize, space, width, height, theme_1.fontSizes.h5, function (props) { return props.hoverColor; }, function (props) { return props.focusColor; });
