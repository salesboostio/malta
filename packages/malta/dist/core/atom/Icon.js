...
var StyledSvg = styled_components_1.default.svg.attrs(function (props) { return ({
    xmlns: "http://www.w3.org/2000/svg",
    width: props.size,
    height: props.size
}); })(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  box-sizing: border-box;\n  ", "\n  ", "\n  ", "\n  ", "\n  transition: all 0.15s ease-out;\n"], ["\n  box-sizing: border-box;\n  ", "\n  ", "\n  ", "\n  ", "\n  transition: all 0.15s ease-out;\n"])), styled_system_1.color, utils_1.hover, utils_1.cursor, styled_system_1.space);
...
var getIcons = function (name) {
    var icons = {
        "arrow-down": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fill: "currentColor", d: "M12 16.485l9.192-9.192a1 1 0 0 1 1.415 1.414l-9.9 9.9a1 1 0 0 1-1.414 0l-9.9-9.9a1 1 0 1 1 1.415-1.414L12 16.485z" })
        },
        "arrow-left": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fill: "currentColor", d: "M8.243 12.314l7.778-7.778a1 1 0 1 0-1.414-1.415L6.12 11.607a1 1 0 0 0 0 1.414l8.486 8.485a1 1 0 1 0 1.414-1.414l-7.778-7.778z" })
        },
        "arrow-right": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fill: "currentColor", d: "M16.385 12.314L8.607 4.536A1 1 0 1 1 10.02 3.12l8.485 8.486a1 1 0 0 1 0 1.414l-8.485 8.485a1 1 0 1 1-1.414-1.414l7.778-7.778z" })
        },
        "arrow-up": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fill: "currentColor", d: "M12 7.515l9.192 9.192a1 1 0 0 0 1.415-1.414l-9.9-9.9a1 1 0 0 0-1.414 0l-9.9 9.9a1 1 0 1 0 1.415 1.414L12 7.515z" })
        },
        "back": {
            width: 24,
            height: 24,
            path: React.createElement("g", { fill: "currentColor", transform: "matrix(-1 0 0 1 24 0)" },
        ...
        "close": {
            ...
            path: React.createElement(React.Fragment, null,
                ...
                React.createElement("path", { fill: "currentColor", d: "M13.414 12l9.193 9.192a1 1 0 1 1-1.415 1.415L12 13.414l-9.192 9.193a1 1 0 0 1-1.415-1.415L10.586 12 1.393 2.808a1 1 0 0 1 1.415-1.415L12 10.586l9.192-9.193a1 1 0 1 1 1.415 1.415L13.414 12z" }))
        },
        "crown": {
            width: 24,
            height: 24,
            path: React.createElement("g", { fill: "currentColor", fillRule: "nonzero" },
        ...
        "gridview": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fillRule: "nonzero", stroke: "currentColor", d: "M4.5 4.5v6h6v-6h-6zm0 9v6h6v-6h-6zm9-9v6h6v-6h-6zm0 9v6h6v-6h-6z" })
        },
        "helpbadge": {
            width: 51,
            height: 20,
            path: React.createElement("path", { fill: "currentColor", d: "M2 0h47a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm7.4 15h1.302v-4.844h4.788V15h1.288V4.738H15.49v4.298h-4.788V4.738H9.4V15zm10.192 0h6.076v-1.106h-4.774v-3.738h3.892V9.05h-3.892V5.83h4.62V4.738h-5.922V15zm8.232 0h5.782v-1.106h-4.48V4.738h-1.302V15zm7.588 0h1.302v-4.074h1.694c2.24 0 3.78-1.008 3.78-3.178 0-2.24-1.54-3.01-3.85-3.01h-2.926V15zm1.302-5.124V5.788h1.47c1.806 0 2.716.476 2.716 1.96 0 1.47-.854 2.128-2.66 2.128h-1.526z" })
        },
        "listview": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fill: "currentColor", fillRule: "nonzero", d: "M5 5a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm0 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm4-6h10a1 1 0 0 1 0 2H9a1 1 0 1 1 0-2zm0 6h10a1 1 0 0 1 0 2H9a1 1 0 0 1 0-2zm-4 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm4 0h10a1 1 0 0 1 0 2H9a1 1 0 0 1 0-2z" })
        },
        "next": {
            width: 24,
            height: 24,
        ...
        "search": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fillRule: "nonzero", stroke: "currentColor", strokeWidth: "2", d: "M15.736 15.736l3.518 3.518-3.518-3.518zm3.518 3.518l3.202 3.202-3.202-3.202zm-3.518-3.518l-.316-.316.56-.7A8.001 8.001 0 0 0 4.07 4.072a8.001 8.001 0 1 0 10.65 11.909l.699-.56.316.316z" })
        },
        "selectall": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fill: "currentColor", fillRule: "nonzero", d: "M8.811 10.522l-1.089 1.09 3.5 3.5L19 7.332l-1.089-1.089-6.689 6.69-2.41-2.412zm8.633 6.922H6.556V6.556h7.777V5H6.556C5.7 5 5 5.7 5 6.556v10.888C5 18.3 5.7 19 6.556 19h10.888C18.3 19 19 18.3 19 17.444v-6.222h-1.556v6.222z" })
        },
        "step": {
            width: 40,
            height: 40,
            path: React.createElement("path", { fill: "currentColor", d: "M16.9 26.627l13.435-13.435a1 1 0 1 1 1.414 1.415L17.607 28.749a1 1 0 0 1-1.415 0l-8.485-8.486a1 1 0 1 1 1.414-1.414l7.778 7.778z" })
        },
        "upload": {
            width: 24,
            height: 24,
            path: React.createElement("g", { fillRule: "nonzero" },
                React.createElement("rect", { width: "1", height: "13", x: "12", y: "5", fill: "currentColor", rx: ".5" }),
                React.createElement("path", { fill: "currentColor", d: "M12.854 3.904l4.242 4.242a.5.5 0 1 1-.707.708L12.5 4.964l-3.89 3.89a.5.5 0 0 1-.706-.708l4.242-4.242a.5.5 0 0 1 .708 0z" }),
                React.createElement("path", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", d: "M2 14v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4" }))
        },
        "reload": {
            width: 24,
            height: 24,
            path: React.createElement("g", { fill: "none", fillRule: "evenodd" },
                React.createElement("path", { stroke: "currentColor", strokeLinecap: "round", strokeWidth: "2", d: "M19.816 1.818v4.908h-4.909" }),
                React.createElement("path", { stroke: "currentColor", strokeLinecap: "round", strokeWidth: "2", d: "M2.363 11.635a9.27 9.27 0 0 1 9.271-9.272 9.248 9.248 0 0 1 7.805 4.265M3.454 21.452v-4.909h4.908" }),
                React.createElement("path", { stroke: "currentColor", strokeLinecap: "round", strokeWidth: "2", d: "M20.907 11.635a9.27 9.27 0 0 1-9.272 9.271 9.25 9.25 0 0 1-7.804-4.264" }))
        },
        "add": {
            width: 24,
            height: 24,
            path: React.createElement("path", { fill: "currentColor", d: "M11 11V3a1 1 0 0 1 2 0v8h8a1 1 0 0 1 0 2h-8v8a1 1 0 0 1-2 0v-8H3a1 1 0 0 1 0-2h8z" })
        },
        "delete": {
            width: 20,
            height: 20,
            path: React.createElement("path", { fill: "currentColor", fillRule: "nonzero", d: "M10 8.821L6.464 5.286a.833.833 0 1 0-1.178 1.178L8.821 10l-3.535 3.536a.833.833 0 1 0 1.178 1.178L10 11.179l3.536 3.535a.833.833 0 0 0 1.178-1.178L11.179 10l3.535-3.536a.833.833 0 0 0-1.178-1.178L10 8.821zM10 20C4.477 20 0 15.523 0 10S4.477 0 10 0s10 4.477 10 10-4.477 10-10 10z" })
        },
        "doublearrow-left": {
            width: 24,
            height: 24,
        ...
        "home": {
            width: 24,
            height: 24,
            path: React.createElement("g", { fill: "currentColor", fillRule: "nonzero", transform: "translate(2 3)" },
        ...
        "ascending": {
            width: 24,
            height: 24,
            path: React.createElement("g", { fill: "currentColor", transform: "translate(1 5)" },
        ...
        "descending": {
            width: 24,
            height: 24,
            path: React.createElement("g", { fill: "currentColor", transform: "translate(1 3)" },
        ...
        "hamburger": {
            ...
            path: React.createElement("g", { fill: "currentColor" },
                React.createElement("g", { transform: "translate(0 2)" },
                    React.createElement("rect", { width: "24", height: "1", rx: ".5" }),
                    React.createElement("rect", { width: "24", height: "1", y: "9", rx: ".5" }),
                    React.createElement("rect", { width: "24", height: "1", y: "18", rx: ".5" })))
        }
    };
    return icons[name];
};
